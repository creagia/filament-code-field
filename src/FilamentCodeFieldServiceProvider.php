...
class FilamentCodeFieldServiceProvider extends PackageServiceProvider
{
    ...
    public function packageBooted(): void
    {
        FilamentAsset::register([
            Css::make(static::$name, __DIR__ . '/../resources/dist/filament-code-field.css')->loadedOnRequest(),
            Js::make(static::$name, __DIR__ . '/../resources/dist/filament-code-field.js')->loadedOnRequest(),
